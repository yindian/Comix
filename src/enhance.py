...
class _EnhanceImageDialog(Gtk.Dialog):
    ...
    def __init__(self, window):
        ...
        self._brightness_scale = Gtk.HScale(adjustment=adj)
        ...
        vbox_left.pack_start(label, True, False, 2)
        adj = Gtk.Adjustment(0.0, -1.0, 1.0, 0.01, 0.1)
        self._contrast_scale = Gtk.HScale(adjustment=adj)
        ...
        vbox_left.pack_start(label, True, False, 2)
        adj = Gtk.Adjustment(0.0, -1.0, 1.0, 0.01, 0.1)
        self._saturation_scale = Gtk.HScale(adjustment=adj)
        ...
        vbox_left.pack_start(label, True, False, 2)
        adj = Gtk.Adjustment(0.0, -1.0, 1.0, 0.01, 0.1)
        self._sharpness_scale = Gtk.HScale(adjustment=adj)
